      ...
      <div className="space-y-5 sm:space-y-6">
        ...
        <section className="rounded-[28px] border border-black/5 bg-white/80 shadow-sm">
          <div className="flex items-center gap-3 border-b border-black/5 px-4 py-5 sm:px-6">
            ...
            <div>
              <h2 className="text-xl font-semibold tracking-[-0.03em] text-[#171821]">Entreprise & agent vocal</h2>
              <p className="mt-1 text-sm text-[#6f685d]">Configurez le mode d’appel, le transfert humain et les garde-fous du réceptionniste IA.</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 px-4 py-5 sm:px-6 sm:py-6">
            ...
            <div className="grid gap-5 lg:grid-cols-2">
              <div>
                <label htmlFor="offerMode" className="block text-sm font-medium text-[#171821]">
                  Mode actif
                </label>
                <select
                  id="offerMode"
              ...
              <div>
                <label htmlFor="humanTransferNumber" className="block text-sm font-medium text-[#171821]">
            ...
            <div className="grid gap-5 lg:grid-cols-2">
              <div>
                <label htmlFor="maxAgentFailures" className="block text-sm font-medium text-[#171821]">
                ...
                <input
                  ...
                  onChange={(e) => setFormData({
                    ...
                    settings: {
                      ...formData.settings,
                      maxAgentFailures: Number(e.target.value || 1),
                    },
                  })}
                  className="mt-2 block w-full rounded-2xl border border-black/10 bg-[#fcfbf8] px-4 py-3 text-sm text-[#171821] outline-none transition focus:border-black/20 focus:bg-white"
                />
              ...
              <div>
                <label htmlFor="greetingText" className="block text-sm font-medium text-[#171821]">
                  Message d’accueil Offre B
                </label>
                <input
                  type="text"
                  id="greetingText"
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              <div className="rounded-[24px] border border-black/5 bg-[#f7f4ee] p-4 sm:p-5">
                <div className="flex items-start gap-3">
                  <Bot className="mt-0.5 h-5 w-5 text-[#171821]" />
                  <div className="min-w-0 flex-1">
                    <label className="flex items-center justify-between gap-4 text-sm font-medium text-[#171821]">
                      ...
                      <input
                        ...
                        className="h-4 w-4 rounded border-black/20 text-[#111118] focus:ring-[#111118]"
                      />
                    </label>
                    <p className="mt-2 text-sm leading-6 text-[#6f685d]">Permet d’utiliser le flux temps réel de l’offre B au lieu du simple répondeur.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-[24px] border border-black/5 bg-[#f7f4ee] p-4 sm:p-5">
                <div className="flex items-start gap-3">
                  <Database className="mt-0.5 h-5 w-5 text-[#171821]" />
                  <div className="min-w-0 flex-1">
                    <label className="flex items-center justify-between gap-4 text-sm font-medium text-[#171821]">
                      ...
                      <input
                        ...
                        onChange={(e) => setFormData({
                          ...
                          settings: {
                            ...formData.settings,
                            knowledgeBaseEnabled: e.target.checked,
                          },
                        })}
                        className="h-4 w-4 rounded border-black/20 text-[#111118] focus:ring-[#111118]"
                      />
                    </label>
                    <p className="mt-2 text-sm leading-6 text-[#6f685d]">Quand elle est active, l’agent peut s’appuyer sur les informations ci-dessous pour répondre sans halluciner.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-[24px] border border-black/5 bg-[#f7f4ee] p-4 sm:p-5">
                <div className="flex items-start gap-3">
                  <PhoneForwarded className="mt-0.5 h-5 w-5 text-[#171821]" />
                  <div className="min-w-0 flex-1">
                    <label className="flex items-center justify-between gap-4 text-sm font-medium text-[#171821]">
                    ...
                    <p className="mt-2 text-sm leading-6 text-[#6f685d]">Si l’agent temps réel échoue, l’appel pourra revenir au flux sûr de l’offre A.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-[24px] border border-black/5 bg-[#f7f4ee] p-4 sm:p-5">
                <div className="flex items-start gap-3">
                  <Sparkles className="mt-0.5 h-5 w-5 text-[#171821]" />
                  <div className="min-w-0 flex-1">
                    <label className="flex items-center justify-between gap-4 text-sm font-medium text-[#171821]">
                      <span>Réservation prévue plus tard</span>
                      <input
                        type="checkbox"
                        checked={formData.settings.appointmentIntegrationEnabled}
                        onChange={(e) => setFormData({
                          ...formData,
                          settings: {
                            ...formData.settings,
                            appointmentIntegrationEnabled: e.target.checked,
                          },
                        })}
                        className="h-4 w-4 rounded border-black/20 text-[#111118] focus:ring-[#111118]"
                      />
                    </label>
                    <p className="mt-2 text-sm leading-6 text-[#6f685d]">Ce flag réserve le terrain pour les futures intégrations agenda sans activer encore la prise de rendez-vous.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="rounded-[28px] border border-black/5 bg-white/80 shadow-sm">
          <div className="flex items-center gap-3 border-b border-black/5 px-4 py-5 sm:px-6">
            ...
            <div>
              <h2 className="text-xl font-semibold tracking-[-0.03em] text-[#171821]">Base de connaissances</h2>
              <p className="mt-1 text-sm text-[#6f685d]">Renseignez les informations que l’agent doit connaître avant de répondre ou d’escalader vers un humain.</p>
            </div>
          </div>

          <div className="grid gap-6 px-4 py-5 sm:px-6 sm:py-6 lg:grid-cols-[0.95fr_1.05fr]">
            <form onSubmit={handleKnowledgeSubmit} className="space-y-5 rounded-[24px] border border-black/5 bg-[#f7f4ee] p-4 sm:p-5">
              {knowledgeMessage && (
                <div className={`rounded-2xl border px-4 py-3 text-sm font-medium ${
              ...
              <div>
                <label htmlFor="knowledgeTitle" className="block text-sm font-medium text-[#171821]">
                  Titre
                </label>
                <input
                  type="text"
              ...
              <div className="grid gap-4 sm:grid-cols-[1fr_120px]">
                <div>
                  <label htmlFor="knowledgeCategory" className="block text-sm font-medium text-[#171821]">
                    Catégorie
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="knowledgePriority" className="block text-sm font-medium text-[#171821]">
                    Priorité
                  </label>
                  <input
                    type="number"
                    ...
                    className="mt-2 block w-full rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm text-[#171821] outline-none transition focus:border-black/20"
                  />
                </div>
              </div>

              <div>
                <label htmlFor="knowledgeContent" className="block text-sm font-medium text-[#171821]">
                  Contenu métier
                </label>
                <textarea
                  id="knowledgeContent"
              ...
              <label className="flex items-center justify-between gap-4 rounded-2xl border border-black/10 bg-white px-4 py-3 text-sm font-medium text-[#171821]">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                {editingKnowledgeId && (
                  <button
                    ...
                    className="rounded-full border border-black/10 bg-white px-4 py-2 text-sm font-medium text-[#171821] transition hover:bg-[#fcfbf8]"
                  >
                    Annuler l’édition
                  </button>
                )}
            ...
            <div className="space-y-3">
              {knowledgeEntries.length === 0 ? (
                <div className="rounded-[24px] border border-dashed border-black/10 bg-[#f7f4ee] px-6 py-10 text-center">
                  <p className="text-base font-medium text-[#171821]">Aucune information métier pour l’instant</p>
                  <p className="mt-2 text-sm text-[#6f685d]">Ajoute ici les réponses et données d’entreprise sur lesquelles l’agent devra s’appuyer.</p>
                </div>
              ) : (
                knowledgeEntries.map((entry) => (
                  <div key={entry.id} className="rounded-[24px] border border-black/8 bg-[#fcfbf8] p-4 sm:p-5">
                    <div className="flex flex-col gap-4">
                      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                        <div className="min-w-0">
                          <div className="flex flex-wrap items-center gap-2">
                            <p className="text-sm font-semibold text-[#171821] sm:text-base">{entry.title}</p>
                            {entry.category && (
                              <span className="inline-flex items-center rounded-full bg-[#ece6dc] px-3 py-1 text-xs font-medium text-[#625d55]">
                                {entry.category}
                              </span>
                            )}
                            <span className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-medium ${
                              entry.enabled ? 'bg-emerald-100 text-emerald-700' : 'bg-stone-200 text-stone-600'
                            }`}>
                              {entry.enabled ? 'Actif' : 'Désactivé'}
                            </span>
                          </div>
                          <p className="mt-3 whitespace-pre-wrap text-sm leading-7 text-[#5f5a52]">{entry.content}</p>
                        </div>
                      ...
                      <div className="flex flex-wrap items-center gap-3 text-xs text-[#8b8478]">
