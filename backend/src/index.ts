...
import staffAvailabilityRoutes from './routes/staffAvailability';
import outboundCallsRoutes from './routes/outboundCalls';
import dispatchRulesRoutes from './routes/dispatchRules';
import dispatchFlowRoutes from './routes/dispatchFlow';
...
app.use('/api/dispatch/flow', dispatchFlowRoutes);
